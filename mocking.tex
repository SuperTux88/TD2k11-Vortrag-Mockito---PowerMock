...
% TODO namen drehen und logo einblenden
		...
		\subsection{Einführung in Test-driven development}
			...
			\begin{frame}
				...
				\begin{itemize}
					...
					\item{\color{red}\textbf{$\Rightarrow$ Wartbarkeit und hohe Qualitaet}} % TODO remove dot!
				\end{itemize}
			...
			\begin{frame}
				...
				\begin{itemize}
					...
					% Beispiel fuer Grey-Box: Komponente die Socket aufmacht. Socket explizit killen.
				\end{itemize}
				\pause
				Ziele von TTD
				\begin{itemize}
					...
					\item{Sicherstellung der Testqualitaet (Kein Whiteboxtest!)} % kein test der internen komponentenimplementierung!
					\item{\color{red}\textbf{$\Rightarrow$ Wartbarkeit und hohe Qualitaet}} % TODO remove dot!
				\end{itemize}
			\end{frame}
